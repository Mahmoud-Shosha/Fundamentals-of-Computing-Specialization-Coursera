"""
To finish our object-oriented implementation of Memory, complete the implementation of the function mouseclick() in
the provided template based on the state logic described in the Memory video. Again, your code should interact with
the tiles only via Tile class methods. When done correctly, the code should express the logic of this function
in surprisingly readable manner.
"""
...
def mouseclick(pos):
    ...
    if state == 0:
        ...
        if not(turn1_tile.get_number() == turn2_tile.get_number()):
