"""
Modify the __init__ method for bubbles such that the initializer takes an optional sound. This sound should be played
when a bubble is fired. Remember to pass the firing sound to the initializer when creating a bubble.
Test your code with our provided firing sound.
"""
