"""
Add code to your program that spawns a_bubble (a global variable) when the programs starts. Add code to the key handler
that fires the bubble when the space bar is pressed. The bubble's velocity should be parallel to the firing line.
Add calls to update and draw in the draw handler to make the bubble move.
"""
...
def keydown(key):
    ...
    if simplegui.KEY_MAP["left"] == key:
        ...
        a_bubble.fire_bubble([4*orient[0], -4*orient[1]])
