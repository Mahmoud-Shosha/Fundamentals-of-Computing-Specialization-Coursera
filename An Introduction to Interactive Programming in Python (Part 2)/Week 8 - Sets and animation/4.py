"""
For the fourth step, implement a method for bubbles called collide that takes two bubbles self plus another bubble)
and returns True if they collide and False otherwise.
You can use the provided helper function dist that computes the distance between two points in implementing
the collide method.
"""
