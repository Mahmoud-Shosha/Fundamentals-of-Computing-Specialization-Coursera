"""
Our third task is to maintain a set of bubbles that contain 'stuck' bubbles.
When a bubble sticks, add a copy of a_bubble to a set called stuck_bubbles. Modify the draw handlers to draw both
a_bubble and stuck_bubbles, but only update a_bubble.
"""
...
# define draw handler
def draw(canvas):
    global firing_angle, a_bubble, bubble_stuck, stuck_bubbles
