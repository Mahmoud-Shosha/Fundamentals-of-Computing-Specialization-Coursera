"""
Write a Python function rectangle_perimeter that takes two parameters width and height corresponding
...
def rectangle_perimeter(width, height):
    """Return a rectangle perimeter given its width and height"""
