"""
Write a Python function future_value that takes three parameters present_value, annual_rate and
years and returns the future value of present_value dollars invested at annual_rate percent interest,
...
def future_value(present_value, annual_rate, years):
    """
    Returns the future value of the present_value invested at annual_rate percent interest,
