"""
Heron's formula states the area of a triangle is sqr(s(s-a)(s-b)(s-c)) where a, b and c are
the lengths of the sides of the triangle and s=0.5(a+b+c) is thesemi-perimeterof the triangle.
Given the variables x0, y0, x1,y1, x2, and y2, write a Python program that computes a variable area
